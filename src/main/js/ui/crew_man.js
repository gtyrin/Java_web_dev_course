...
/**
 * Страница представления и изменения данных для сущности "член экипажа".
 */
...
class CrewManList extends crt.CommonReferenceDataList {
    ...
    render() {
        ...
        return super.defaultRender(objects, "Last name", "First name", "Mid name", "Age", "Spec", "Flying hours")
    }
}
